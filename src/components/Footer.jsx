...
const Footer = () => {
  ...
  return (
    <footer>
        ...
        <div className="mt-20 mb-10 flex flex-col md:flex-row items-start justify-between gap-8">
          ...
          <div className="md:w-[400px]">
           <h1><b>BRANCHE</b></h1>
            ...
            Step into the world of trendsetting fashion where style meets comfort. At [Branche], we bring you a curated collection of apparel, accessories, and footwear for every occasion. Whether you’re looking for chic everyday essentials, statement party wear, or timeless classics, we’ve got you covered.
            </p>
      ...
      <p className="text-white text-center items-center py-3">© {currentYear} Branche, Inc.</p>
      </div>
    </footer>
  );
};
